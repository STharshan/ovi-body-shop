...
const Navbar = () => {
  ...
  const navItems = [
    { name: "DEMOS", hasPlus: true },
    { name: "ABOUT US", hasPlus: true },
    { name: "SHOP", hasPlus: false },
    { name: "CAREER", hasPlus: false },
    { name: "ALL PAGES", hasPlus: true },
  ];

  return (
    <nav className="bg-black text-white tracking-wide">
