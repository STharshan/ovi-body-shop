...
const CarService = () => {
    return (
        <div>
            <HeroSection data={ServiceHero.CarService}/>
            <MainService data={MainServices.CarServicing}/>
            <ServiceSection data={Servicesterm.MOTPreTestService}/>
            <WhySection data={WhyChoose.WhyChooseCarServicing}/>
        </div>
    )
}
